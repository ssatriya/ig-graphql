...
export const Icons: IconsType = {
  instagramLogoType: (props: LucideProps) => (
    <svg
      {...props}
  ...
  searchActive: (props: LucideProps) => (
    <svg
      {...props}
      aria-label="Search"
      fill="currentColor"
  ...
  exploreActive: (props: LucideProps) => (
    <svg
      {...props}
      aria-label="Explore"
      fill="currentColor"
  ...
  messageActive: (props: LucideProps) => (
    <svg
      {...props}
      aria-label="Messenger"
      height="24"
  ...
  photoAndVideo: (props: LucideProps) => (
    <svg
      {...props}
  ...
  yourActivity: (props: LucideProps) => (
    <svg
      {...props}
  ...
  photoOutline: (props: LucideProps) => (
    <svg
      {...props}
  ...
  cropPortrait: (props: LucideProps) => (
    <svg
      {...props}
  ...
  cropLandscape: (props: LucideProps) => (
    <svg
      {...props}
  ...
  plusIconLarge: (props: LucideProps) => (
    <svg
      {...props}
      aria-label="Plus icon"
      fill="currentColor"
  ...
  moreCircleLarge: (props: LucideProps) => (
    <svg
      {...props}
      aria-label="Options"
      fill="currentColor"
